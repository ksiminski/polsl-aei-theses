...
\newcommand{\Program}{$\langle$wpisać właściwy$\rangle$}            % kierunek studiów
\newcommand{\Specialisation}{$\langle$wpisać właściwą$\rangle$}     % specjalność
\newcommand{\Id}{$\langle$wpisać właściwy$\rangle$}                 % numer albumu
\newcommand{\Departament}{$\langle$wpisać właściwą$\rangle$}        % katedra promotora

% Jeżeli został wyznaczony promotor pomocniczy lub opieku proszę go/ją wpisać ...
\newcommand{\Consultant}{$\langle$stopień naukowy imię i nazwisko$\rangle$}
