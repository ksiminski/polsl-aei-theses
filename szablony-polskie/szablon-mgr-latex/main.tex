...
\newcommand{\Departament}{$\langle$wpisać właściwą$\rangle$}  % nazwa katedry promotora
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                             %
% KONIEC DANYCH O PRACY DYPLOMOWEJ            %
%                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% TODO
% Lista dodatkowych plików, uzupełniających tekst pracy – jeżeli dotyczny, w przeciwnym razie – zakomentuj!
