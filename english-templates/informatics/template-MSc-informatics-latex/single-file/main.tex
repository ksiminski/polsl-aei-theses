...
\usepackage{csquotes}
\usepackage[natbib=true,backend=bibtex]{biblatex}  % compilation of bibliography with BibTeX
%\usepackage[natbib=true,backend=biber]{biblatex}  % compilation of bibliography with Biber
\bibliography{biblio}
